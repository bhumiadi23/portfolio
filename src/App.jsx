...
const platforms = [
  ...
  { name: 'CodeChef', handle: '@bhumiadi_23', url: 'https://www.codechef.com/users/bhumiadi_23', color: '#ECCA7E', icon: <Target size={22} />, mainStat: '1600+', mainLabel: 'Rating', subStats: [{ val: '3★', label: 'Division', color: '#ECCA7E' }, { val: '80+', label: 'Problems', color: 'white' }], badges: ['3★ Coder', 'Compete', 'Long Challenges'] },
